        ...
        return (
            <div className="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                ...
                <div className="mt-3">
                    ...
                    <div className="my-3">
                        <Link to={"/list/" + ele.id} className="font-semibold hover:text-violet-600">{ele.name}</Link>
                    </div>
            ...
            <section className="relative table w-full py-36 bar-bg-5 bg-center bg-no-repeat">
                ...
                <div className="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
                    <ul className="breadcrumb tracking-[0.5px] breadcrumb-light mb-0 inline-block">
                        ...
                        <li className="inline breadcrumb-item text-[15px] font-semibold duration-500 ease-in-out text-white" aria-current="page"> Listing</li>
                    </ul>
                </div>
            </section>
