...
import image from '../../../../assets/images/avatar/img_03.jpg';
import single from '../../../../assets/images/backgrounds/image_3.jpg';
import image1 from '../../../../assets/images/backgrounds/image_4.jpg';
                ...
                <div className="container">
                    <div className="md:flex justify-center">
                        <div className="lg:w-3/5">
                            <h5 className="md:text-3xl text-2xl md:leading-snug leading-snug font-semibold">TOKEN2040: The Future of Crypto, Decrypted</h5>
                            <p className="text-slate-400 text-lg mt-4">The NFT space has made unprecedented progress since we first launched G-rooves in late 2021, as it hit several major milestones in the past…</p>

                            <div className="flex mt-5">
                                <span className="font-medium"><i className="uil uil-calendar-alt me-2"></i>20th October, 2022</span>
                                <span className="ms-3 font-medium"><i className="uil uil-clock me-2"></i>5 min read</span>
                            </div>
                    ...
                    <div className="md:flex justify-center mt-6">
                        <div className="lg:w-full">
                            <div className="relative">
                                <img src={single} className="rounded-lg shadow-md dark:shadow-gray-800" alt="" />
