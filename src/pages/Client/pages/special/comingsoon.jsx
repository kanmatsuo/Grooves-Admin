                        ...
                        <div className="flex flex-col min-h-screen justify-center md:px-10 py-10 px-4">
                            ...
                            <div className="title-heading text-center my-auto">
                                <div className="md:my-0 my-10">
                                    ...
                                    <p className="text-white/70 max-w-xl mx-auto">We are a huge marketplace dedicated to connecting great artists of all G-rooves with their fans and unique token collectors!</p>
                            ...
                            <div className="text-center">
                                <p className="mb-0 text-white">© {(new Date().getFullYear())}{" "} G-rooves. Design with <i className="mdi mdi-heart text-red-600"></i> by <Link to="https://grooves.in/" target="_blank" className="text-reset">grooves</Link>.</p>
                            </div>
                        </div>
                    </div>
                </div>
