...
const Component = forwardRef((props, ref) => {
    ...
    const addToGachaList = async () => {
        try {
            ...
            var tx = await gachaContract.methods.addGachaList(idsForCreate).send({ from: account });
            ...
            for (var i = 0; i < count; i++) {
                ...
                var message = "#" + idsForCreate[i] + " Token Successfully add to Gacha list!"
                notify(message);
            }
            ...
            <div className="card">
                ...
                <div className="flex justify-content-center">
                    <div className='flex justify-content-center my-5 pt-3'>
                        <Button label="ADD TO GACHA" onClick={addToGachaList} loading={loading} className='gradientBtn03' icon="pi pi-check" />
                    </div>
                </div>
            </div>
        </>
